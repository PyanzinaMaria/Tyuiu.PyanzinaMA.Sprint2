...
namespace Tyuiu.PyanzinaMA.Sprint2.Task3.V13
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Hаписать программу, которая вычисляет требуемое значение функции Y      *");
...
//Hаписать программу, которая вычисляет требуемое значение функции Y
//с использованием вложенных оператор if-else, где пользователь
